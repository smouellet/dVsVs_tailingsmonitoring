# Code is attributed to Loic Viens, from: https://github.com/lviens/2018_JGR/blob/master/Codes/Stretching_current.py

import numpy as np
import scipy

def stretching(ref, cur, t, dvmin, dvmax, nbtrial, window, fmin, fmax, tmin, tmax):
    """
    Stretching function: 
